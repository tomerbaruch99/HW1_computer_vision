...
def visualize_predictions(video_path, output_path, model, classid_classname, save_dir='./ood_vid_predictions'):
    ...
    for result in results:
        ...
        for box in result.boxes:
            ...
            cv2.rectangle(frame, (x1, y1), (x2, y2), (127, 0, 255), 2) # (0, 255, 0)
            class_id = int(box.cls.item())
            confidence = float(box.conf.item())
            cv2.putText(frame, f'{classid_classname[class_id]} , {confidence:.2f}', (x1, y1 - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (127, 0, 255), 2) # (255, 105, 180) (0, 255, 0)
